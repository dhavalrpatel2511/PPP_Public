...
# load the nodes and element data
node_file = 'nodes.dat'
...
# initialize the shape function array
...
# print(New_nodes[:,0]) 
# New_nodes_column_one = New_nodes[:,0]
# New_nodes_column_one = New_nodes_column_one.astype(int)
# print(New_nodes_column_one)
# New_nodes[:,0] = New_nodes_column_one[:]
# New_nodes_1 = np.zeros_like(New_nodes[:,1])
# New_nodes_2 = np.zeros_like(New_nodes[:,2])
# New_nodes_1 = New_nodes[:,1] 
# New_nodes_2 = New_nodes[:,2]
# print(New_nodes)
# New_nodes = New_nodes#.astype(int)
# new_row = np.array([int(x) for x in New_nodes[:, 0]])
# New_nodes[:, 0] = np.around(new_row, decimals=0)
# print('hi', new_row)
# print(New_nodes_1)
# print(New_nodes_2)
# New_nodes[:,1] = New_nodes_1[:]
# New_nodes[:,2] = New_nodes_2[:] 
# print(New_nodes) 
# print(New_nodes)
# with open('New_nodes.dat', 'w', newline='') as file:
